...
def setup_product():
    ...
    import collective.vaporisation
    zcml.load_config('configure.zcml', collective.vaporisation)
    ...
    ztc.installPackage('collective.vaporisation')
...
setup_product()
ptc.setupPloneSite(products=['collective.vaporisation'])
